package com.assisdesign.imageliteapi.config;

import com.assisdesign.imageliteapi.application.jwt.JwtService;
import com.assisdesign.imageliteapi.config.filter.JwtFilter;
    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http, JwtFilter jwtFilter) throws Exception{
        return http
                ...
                .authorizeHttpRequests(auth -> {
                    ...
                    auth.requestMatchers(HttpMethod.DELETE, "/v1/images/**").permitAll();
